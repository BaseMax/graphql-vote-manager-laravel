...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                \App\GraphQL\Queries\getUserQuery::class,
                \App\GraphQL\Queries\getPollQuery::class,
                \App\GraphQL\Queries\getAllPollsQuery::class,
                \App\GraphQL\Queries\getUserPollsQuery::class,
                \App\GraphQL\Queries\getPollCommentsQuery::class,
                \App\GraphQL\Queries\getSurveyQuery::class,
                \App\GraphQL\Queries\getAllSurveysQuery::class,
            ...
            'mutation' => [
                ...
                \App\GraphQL\Mutations\updatePollMutation::class,
                \App\GraphQL\Mutations\deletePollMutation::class,
                \App\GraphQL\Mutations\voteOnOptionMutation::class,
                ...
                \App\GraphQL\Mutations\createCommentMutation::class,
                \App\GraphQL\Mutations\deleteCommentMutation::class,
                \App\GraphQL\Mutations\createSurveyMutation::class,
                \App\GraphQL\Mutations\updateSurveyMutation::class,
                \App\GraphQL\Mutations\deleteSurveyMutation::class,
                \App\GraphQL\Mutations\submitSurveyMutation::class,
                \App\GraphQL\Mutations\resetPollVotesMutation::class,
                \App\GraphQL\Mutations\resetSurveyResponsesMutation::class,
            ],
            // The types only available in this schema
            'types' => [
                \App\GraphQL\Types\UserType::class,
                \App\GraphQL\Types\PollType::class,
                \App\GraphQL\Types\PollOptionType::class,
                \App\GraphQL\Types\PollVoteType::class,
